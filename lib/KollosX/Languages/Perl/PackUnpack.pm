package KollosX::Languages::Perl::PackUnpack;
...
C<KollosX::Languages::Perl::PackUnpack> - Parse the templates used in pack() and unpack()
...
=head1 Synopsis
	...
	my($parser) = KollosX::Languages::Perl::PackUnpack -> new(options => print_warnings);
	my(@text)   =
	(
		qq|n/a* # Newline
	w/a2|,
...
L<KollosX::Languages::Perl::PackUnpack> provides a L<Marpa::R2>-based parser for parsing the
...
Install L<KollosX::Languages::Perl::PackUnpack> as you would any C<Perl> module:

Run:

	cpanm KollosX::Languages::Perl::PackUnpack

or run:

	sudo cpan KollosX::Languages::Perl::PackUnpack
...
C<new()> is called as C<< my($parser) = KollosX::Languages::Perl::PackUnpack -> new(k1 => v1, k2 => v2, ...) >>.

It returns a new object of type C<KollosX::Languages::Perl::PackUnpack>.
...
L<https://github.com/ronsavage/KollosX-Languages-Perl-Pack>

=head1 Support

Email the author, or log a bug on RT:

L<https://rt.cpan.org/Public/Dist/Display.html?Name=KollosX::Languages::Perl::PackUnpack>.

=head1 Author

L<KollosX::Languages::Perl::PackUnpack> was written by Ron Savage I<E<lt>ron@savage.net.auE<gt>> in 2015.
